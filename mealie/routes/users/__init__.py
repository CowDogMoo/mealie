...
from . import api_tokens, crud, feedback, forgot_password, images, ratings, registration
...
router.include_router(feedback.router, prefix=user_prefix, tags=["Users: Feedback"])
